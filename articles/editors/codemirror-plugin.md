...
![CodeMirror-Plugin-Einstellungen](../../../en/images/editors/codemirror-plugin/01-codemirror-plugin-tab.png)

Der folgende Screenshot zeigt die HTML-Farbhervorhebung und den als Schaltflächenreihe implementierten *CMS-Inhalt*:

![CodeMirror in Gebrauch](../../../en/images/editors/codemirror-plugin/02-codemirror-example.png)
